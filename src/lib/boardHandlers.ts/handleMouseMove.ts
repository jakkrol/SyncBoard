  ...
  export function handleMouseMove(e: React.MouseEvent, canvasRef: React.RefObject<HTMLCanvasElement | null>, drawing: React.RefObject<boolean>, lastPos: React.RefObject<{x: number, y: number} | null>, getPositionMouse: (e: React.MouseEvent) => {x: number, y: number}, socket: any, room: string) {
